...
def get_lstm_features(train_df, test_df, text_col, category_col, rnd=42):
    ...
    for train_index, val_index in kf.split(tmp_x):
        ...
        model.add(LSTM(WORD_DIM, dropout=0.2, recurrent_dropout=0.2, return_sequences=True))
        model.add(Flatten())
