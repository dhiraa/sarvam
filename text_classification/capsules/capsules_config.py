...
# LSTM params
flags.DEFINE_integer('word_embedding_size', 128, 'word embedding size')
flags.DEFINE_integer('word_lstm_hidden_size', 128, 'lst hidden size for words')
flags.DEFINE_integer('num_word_lstm_layers', 0.5, 'number of word lstm layers')
