...
class StackGanConfig(ModelConfigBase):
    ...
    def user_config(batch_size):
        ...
        config = StackGanConfig(_model_dir, batch_size)
        StackGanConfig.dump(_model_dir, config)
        return config
...
class StackGan(tf.estimator.Estimator):
    def __init__(self,
    ...
    def _model_fn(self, features, labels, mode, params):
        ...
        :param features: of type `asariri.dataset.features.asariri_features.AudioImageFeature`.
                        Expect Audio to be an flatten array of size 3920 and image size of 64 X 64,
        :param labels: 
        :param mode: 
        :param params: 
        :return: 
        ...
        z_placeholder = features[self._feature_type.AUDIO]  # Audio Placeholder for input images to the discriminator
        ...
        if mode != ModeKeys.INFER:
            ...
            x_placeholder =  features[self._feature_type.IMAGE]   # Placeholder for input image/noise vectors to the generator
