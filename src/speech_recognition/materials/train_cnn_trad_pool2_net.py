...
def run_train():
    ...
    out_dir  = '/root/share/project/kaggle/tensorflow/results/cnn_trad_pool2_net-12' # s_xx1'
    initial_checkpoint = \
        None #'/root/share/project/kaggle/tensorflow/results/cnn_trad_pool2_net-02/checkpoint/00095000_model.pth'
        #
