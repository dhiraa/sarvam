...
def get_cnn_feats(train_df, test_df, text_col, category_col,
                  text_tranformer_fn, rnd=42):
    '''
    ...
    :param text_col: 
    :param category_col: 
    :param text_tranformer_fn: Takes one of the sarvam.eda.meta_features function  
    :param rnd: 
    :return: 
    '''
    ...
    train_df[text_col] = train_df[text_col].apply(text_tranformer_fn)
    test_df[text_col] = test_df[text_col].apply(text_tranformer_fn)
