...
class TextDataFrame():
    def __init__(self,
        ...
        dataset_dir = EXPERIMENT_DATA_ROOT_DIR + "/" + dataset_name + "/"
        ...
        if not os.path.exists(dataset_dir+ "train_processed.json") or \
            ...
            print_info("Loading processed files...")
            print_warn("Loading files from " + dataset_dir)
